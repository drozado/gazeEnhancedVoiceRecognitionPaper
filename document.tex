...
\begin{itemize}
  ...
  \item Gaze: Fixating on a word with gaze for a dwell time of 2 seconds would pop-up the correction panel with the list
  of at most 5 alternative words. Similarly, the alternative word could be selected by fixating the gaze for 2 seconds over it.
...
the speech recognition engine using different correction modalities required to reach the target sentence.}
\label{timeFig}
\end{figure}
...
achieved sentence during the experimental trials. Here, it is important to emphasize that most of the subjects
...
opening the correction panel in the word with the least amount of recognition confidence that is nearest to the gaze
position. Innovative dynamic displays of alternative words could also help in this regard.
...
the other hand-free modality to correct misrecognized words, using voice, in all the variables being monitored in the
user study. Furthermore, the gaze based correction modality also prevents the appearance of voice strain for the
correction of misrecognized words since it prevents considerably the amount of of speech utterances required to correct
a word. In light of the evidence presented here, we assert the advantages of the proposed multimodal approach to HCI that
