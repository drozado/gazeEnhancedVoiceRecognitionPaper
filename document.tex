...
be perfectly valid for some scenarios, but this correction modality is not truly hands-free anymore.
...
this correction modality is extremely error-prone and frustrating for users since the user has to first select by voice
the wrong word, then repeat over and over again the right words until it is properly recognized, and then choosing it
from a list of similar alternatives. Since all of this has to be done by voice, errors are frequent. Users with a
...
with the voice and mouse and keyboard correction methods. For this purpose, a graphical user interface (GUI) was
...
subject comfortable with the interface.
...
\begin{itemize}
  ...
  of 5 alternative words, which could also be selected by clicking. When the desired word was not presented as
  ...
  5 alternative words. Similarly, the alternative word could be selected by fixating the gaze for 2 seconds over it.
